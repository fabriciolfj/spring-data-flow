...
public class ImageToDropboxConfiguration {
    ...
    private final String MOVIE_TABLE_SQL = "create table if not exists ar(" +
            " id varchar(10) primary key, " +
            "url varchar(500));";

    private final String MOVIES_TABLE_SQL = "CREATE TABLE IF NOT EXISTS art(" + " id varchar(10) primary key," + " url varchar(500));";
    private final String MOVIES_INSERT_SQL_1 = "insert into art (id,url) " + "values ('tt0133093','https://m.media-amazon.com/images/M/MV5BNzQzOTk3OTAtNDQ0Zi00ZTVkLWI0MTEtMDllZjNkYzNjNTc4L2ltYWdlXkEyXkFqcGdeQXVyNjU0OTQ0OTY@._V1_.jpg');";
    private final String MOVIES_INSERT_SQL_2 = "insert into art (id,url) " + "values ('tt0209144','https://m.media-amazon.com/images/M/MV5BZTcyNjk1MjgtOWI3Mi00YzQwLWI5MTktMzY4ZmI2NDAyNzYzXkEyXkFqcGdeQXVyNjU0OTQ0OTY@._V1_.jpg');";
    ...
    public CommandLineRunner process(DataSource dataSource, ImageToDropboxUtils imageToDropBoxUtils) {
        return args -> {
            ...
            String url = null;
            url = jdbcTemplate.queryForObject(MOVIES_QUERY_SQL, new Object[]{MATRIX_ART_ID}, String.class);
            log.debug("URL: {}", url);
            imageToDropBoxUtils.fromUrlToDropBox(url, MATRIX_ART_ID + ".jpg");
            url = jdbcTemplate.queryForObject(MOVIES_QUERY_SQL, new Object[]{MEMENTO_ART_ID}, String.class);
            log.debug("URL: {}", url);
